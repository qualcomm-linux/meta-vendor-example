# Contributing to meta-vendor-example
...
1. [Fork](https://github.com/qualcomm-linux/meta-vendor-example/fork) and clone the repository.

    ```bash
    git clone https://github.com/<my-user-name>/meta-vendor-example.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/meta-vendor-example.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/meta-vendor-example/pulls) from your branch to `main`.
